...
public class ViewController extends BorderPane implements Initializable{
	...
	private model.menu.MenuJDBC db;
	...
	public static class MenuItemData{
	    ...
	    public MenuItemData (model.menu.MenuItem item){
			...
			public model.menu.MenuItem setItem(){
				return new model.menu.MenuItem(Integer.parseInt(getItem_id()), tempName, tempPrice, tempDes);
			}
	}
	...
	public void initializeTable() throws ClassNotFoundException, SQLException{
		db=new model.menu.MenuJDBC();
		model.menu.Menu menu = new model.menu.Menu();
		MenuItemData iData;
        ...
        HashMap<Integer, model.menu.MenuItem> hm = new HashMap<>();
        hm = db.populateMenu();
